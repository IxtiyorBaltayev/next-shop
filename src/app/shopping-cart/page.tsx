...
const ShoppingCart = () => {
	...
	return (
		<>
			{products.length ? (
				<div className="min-h-full bg-gray-100 py-20">
					...
					<div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
						...
						<div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
							...
							<button className="mt-6 w-full rounded-md bg-indigo-500 py-1.5 font-medium text-blue-50 hover:bg-indigo-600">
								Check out
							</button>
						</div>
					</div>
				...
				<div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
					<div className="text-center">
						...
						<Link href={"/products"}>
							<button className="inline-flex items-center bg-indigo-500 text-white border-transparent border py-2 px-5 focus:outline-none hover:bg-transparent hover:text-black hover:border-black rounded text-base mt-4 transition duration-200">
								Products
							</button>
						</Link>
					</div>
